...
def _write_crash(exc_type, exc_value, exc_tb):
    ...
    try:
        ...
        _ct.windll.user32.MessageBoxW(0, msg[:1000], "FearMods Basic Panel - Fatal Error", 0x10)
    except Exception:
        pass
...
class TitleBar(QFrame):
    def __init__(self, window, parent=None):
        ...
        self.sub_brand = QLabel('[ BASIC PANEL ]')
...
class CheatScreen(QWidget):
    ...
    def __init__(self, cheat_logic):
        ...
        self.stack.addWidget(self._create_list_page([
            ("Aimbot", "Aim Head Legit", "aimbot", True),
        ...
        self.stack.addWidget(self._create_list_page([
            ...
            ("Esp Weapon", "Show Enemy holding weapon", "espweapon", False)
        ], "ESP Features"))
        ...
        self.stack.addWidget(self._create_list_page([
            ...
            ("Streamer Mode", "Hides Esp in ScreenShare", "notif", False),
    ...
    def _on_check_finished(self, res):
        ...
        if hasattr(self, 'tabs_btns') and len(self.tabs_btns) > 3:
            self.tabs_btns[3].set_notification(update_available)
    ...
    def _on_update_finished(self, success):
        ...
        if success:
            ...
            if hasattr(self, 'tabs_btns') and len(self.tabs_btns) > 3:
                self.tabs_btns[3].set_notification(False)
...
class FearMods(QMainWindow):
    ...
    def toggle_monitor_page(self):
        if self._pages.currentIndex() == self.PAGE_CHEAT:
            if self._cheat.stack.currentIndex() == 4:
                self._cheat._set_tab(0)
            else:
                self._cheat._set_tab(4)
    ...
    def _build_window(self):
        ...
        self._login.set_app_name("BASIC PANEL")
